import chatREFERENE from "../modals/chatSCHEMA.js";
...
async function accesschat(req , res){
    ...
    try {
        ...
        const waiter = await chatREFERENE.findOne(  {
        ...
        if( !waiter ) { 
            ...
            const saver = await chatREFERENE.create(newchatdata)
...
async function fetchchats(req , res){
    ...
    try {
        ...
        const myoldchats = await chatREFERENE.find(  {
